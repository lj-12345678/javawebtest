...
mvn archetype:generate -s D:\Aimportant\javawebtest\scripts\settings.xml  "-DgroupId=top.daisy" "-DartifactId=javawebtest" "-DarchetypeArtifactId=maven-archetype-webapp" "-DinteractiveMode=false"